-- USERS
    INSERT INTO users (id, nombre, apellidos, correo, password, telefono, ciudad, foto, created, updated, deleted) VALUES
        (1, 'Admin Principal', 'Admin', 'admin@example.com', '$2a$12$6WNmrE.xxU3QXD.tnKMoS.UizJrZEmn2v54X7hzM/KIzNTdN.piIm', '600000001', 'Madrid', 'https://res.cloudinary.com/dkaxfqkvo/image/upload/v1764953247/persona3_xkd0vp.jpg', NOW(), NOW(), false),
        (2, 'Trabajador Uno', 'Perez', 'trabajador1@example.com', '$2a$12$/d1KeggIn8zzJlkxSiievuWZtxTnPRsx9KhV/34F3ceV1SwZO.WeG', '600000002', 'Barcelona', 'https://res.cloudinary.com/dkaxfqkvo/image/upload/v1764953244/persona13_zyt96q.jpg', NOW(), NOW(), false),
        (3, 'Trabajador Dos', 'Gomez', 'trabajador2@example.com', '$2a$12$0lcB19.P54vSZ.GeZR/Y6Ob/DH3YAk2eRvyhMxt0hi4UVMUA348BK', '600000003', 'Valencia', 'https://res.cloudinary.com/dkaxfqkvo/image/upload/v1764953246/persona6_nqejuh.jpg', NOW(), NOW(), false),
        (4, 'Trabajador Tres', 'Lopez', 'trabajador3@example.com', '$2a$12$r6M0D9rxAx..zSsvHJ9d1OFXDNfy0/VeeQIeGhi1OJT.4/dRkXCr6', '600000004', 'Sevilla', 'https://res.cloudinary.com/dkaxfqkvo/image/upload/v1764953245/persona8_q1m9am.jpg', NOW(), NOW(), false),
        (5, 'Raúl', 'Fernández', 'raulspotify6106@gmail.com', '$2a$12$T25nQ90HvBR/3WIxPryDzeE6IX.pQiFA.wrqfCg/LLVMkFoXVLOje', '600000005', 'Madrid', 'https://res.cloudinary.com/dkaxfqkvo/image/upload/v1764953247/imagenral_wfjber.jpg', NOW(), NOW(), false),
        (6, 'Yahya', 'El Hadri', 'yahya@example.com', '$2a$12$PFvGQIyLW.a2lKL2q8BLvOT1TAO6uGmYwRPxWaRVhIvFRT9ZOzF6W', '600000006', 'Barcelona', 'https://res.cloudinary.com/dkaxfqkvo/image/upload/v1764953244/persona9_z9iuta.jpg', NOW(), NOW(), false),
        (7, 'Samuel', 'Cortes', 'samu@example.com', '$2a$12$PFvGQIyLW.a2lKL2q8BLvOT1TAO6uGmYwRPxWaRVhIvFRT9ZOzF6W', '600000007', 'Valencia', 'https://res.cloudinary.com/dkaxfqkvo/image/upload/v1764953403/oersiba_byuy41.jpg', NOW(), NOW(), false),
        (8, 'Javier', 'Hernandez', 'javi@example.com', '$2a$12$PFvGQIyLW.a2lKL2q8BLvOT1TAO6uGmYwRPxWaRVhIvFRT9ZOzF6W', '600000008', 'Sevilla', 'https://res.cloudinary.com/dkaxfqkvo/image/upload/v1764953492/asda_kccyvh.jpg', NOW(), NOW(), false),
        (9, 'Javier', 'Ruiz', 'javierruiz@example.com', '$2a$12$PFvGQIyLW.a2lKL2q8BLvOT1TAO6uGmYwRPxWaRVhIvFRT9ZOzF6W', '600000009', 'Bilbao', 'https://res.cloudinary.com/dkaxfqkvo/image/upload/v1764953560/asdas_ru6fbr.jpg', NOW(), NOW(), false),
        (10, 'Pedro', 'PicaPiedra', 'pedro@example.com', '$2a$12$PFvGQIyLW.a2lKL2q8BLvOT1TAO6uGmYwRPxWaRVhIvFRT9ZOzF6W', '600000010', 'Zaragoza', 'https://res.cloudinary.com/dkaxfqkvo/image/upload/v1764953596/dass_rxxcbn.jpg', NOW(), NOW(), false),
        (11, 'Ruben', 'Gomez', 'ruben@example.com', '$2a$12$PFvGQIyLW.a2lKL2q8BLvOT1TAO6uGmYwRPxWaRVhIvFRT9ZOzF6W', '600000011', 'Madrid', 'https://res.cloudinary.com/dkaxfqkvo/image/upload/v1764953631/qwqw_xapz4n.jpg', NOW(), NOW(), false),
        (12, 'Sergio', 'Peña', 'sergio@example.com', '$2a$12$PFvGQIyLW.a2lKL2q8BLvOT1TAO6uGmYwRPxWaRVhIvFRT9ZOzF6W', '600000012', 'Barcelona', 'https://res.cloudinary.com/dkaxfqkvo/image/upload/v1764953669/sadasas_d8cpe6.jpg', NOW(), NOW(), false),
        (13, 'Victor', 'Conde', 'victor@example.com', '$2a$12$PFvGQIyLW.a2lKL2q8BLvOT1TAO6uGmYwRPxWaRVhIvFRT9ZOzF6W', '600000013', 'Valencia', 'https://res.cloudinary.com/dkaxfqkvo/image/upload/v1764953712/sasdasdasd_ybfown.jpg', NOW(), NOW(), false),
        (14, 'Javier', 'Garzas', 'javiergarzas@example.com', '$2a$12$PFvGQIyLW.a2lKL2q8BLvOT1TAO6uGmYwRPxWaRVhIvFRT9ZOzF6W', '600000014', 'Sevilla', 'https://res.cloudinary.com/dkaxfqkvo/image/upload/v1764953782/asdasdq_bjhs57.jpg', NOW(), NOW(), false);
